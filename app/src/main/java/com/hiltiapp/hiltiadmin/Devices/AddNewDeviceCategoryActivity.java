...
public class AddNewDeviceCategoryActivity extends AppCompatActivity {
    private String Name;
    ...
    private StorageReference DeviceCategoriesImagesRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DeviceCategoriesImagesRef = FirebaseStorage.getInstance().getReference().child("Device Categories Images");
    ...
    private void StoreProductInformation()
    {
        ...
        final StorageReference filePath = DeviceCategoriesImagesRef.child(ImageUri.getLastPathSegment() +categoryRandomKey + ".jpg");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(AddNewDeviceCategoryActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        DeviceCategoriesRef.child(categoryRandomKey).updateChildren(itemMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AddNewDeviceCategoryActivity.this, getString(R.string.toast_add_product_successfully) , Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
                            String message = task.getException().toString();
                            Toast.makeText(AddNewDeviceCategoryActivity.this, getString(R.string.toast_add_product_fail) + message, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
