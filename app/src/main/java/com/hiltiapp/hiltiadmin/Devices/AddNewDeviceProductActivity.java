...
public class AddNewDeviceProductActivity extends AppCompatActivity {
    ...
    private StorageReference DeviceProductsImagesRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DeviceProductsImagesRef = FirebaseStorage.getInstance().getReference().child("Device Products Images");
    ...
    private void StoreProductInformation()
    {
        ...
        final StorageReference filePath = DeviceProductsImagesRef.child(ImageUri.getLastPathSegment() +productRandomKey + ".jpg");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(AddNewDeviceProductActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        DeviceProductsRef.child(productRandomKey).updateChildren(itemMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AddNewDeviceProductActivity.this, getString(R.string.toast_add_product_successfully) , Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
                            String message = task.getException().toString();
                            Toast.makeText(AddNewDeviceProductActivity.this, getString(R.string.toast_add_product_fail) + message, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
